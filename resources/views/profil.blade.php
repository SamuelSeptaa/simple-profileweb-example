      ...
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <div class="section-headline text-center">
            <h2>Daftar Dosen Teknik Informatika</h2>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="awesome-project-content">
          ...
          <div class="col-md-4 col-sm-4 col-xs-12 design development">
            <div class="single-awesome-project">
              <div class="team-img">
                @if($i->filefoto==null)
                <a href="#"><img style="width:350px; height:350px" src="img/portfolio/noimage.jpg" alt="" /></a>
                @else
                <a href="#"><img style="width:350px; height:350px" src="img/portfolio/{{$i->filefoto}}" alt="" /></a>
                @endif
